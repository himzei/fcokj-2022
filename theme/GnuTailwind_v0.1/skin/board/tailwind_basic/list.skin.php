    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?> border-b">
            ...
            <td class="td_subject py-3 px-3" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px">
				...
				?>
                <a href="<?php echo $list[$i]['ca_name_href'] ?>" class="bo_cate_link float-left inline-block mr-3 bg-indigo-100 text-indigo-500 font-normal py-0.5 px-1.5 rounded text-base ml-2 show-cell"><?php echo $list[$i]['ca_name'] ?></a>
                <?php } ?>
                <div class="bo_tit">
        ...
        <?php } ?>
        <?php if (count($list) == 0) { echo '<tr><td colspan="'.$colspan.'" class="empty_table text-center pt-8">게시물이 없습니다.</td></tr>'; } ?>
        </tbody>
        </table>
    </div>
