    ...
    <div class="bo_w_tit write_div relative my-2 mx-0">
      ...
      <div id="autosave_wrapper" class="write_div my-2 mx-0 border p-1.5">
        ...
        ?>
          ...
          <button type="button" id="btn_autosave" class="btn_frmline absolute top-1 right-1 leading-7 h-7 text-base inline-block w-32 py-0 px-1 border-0 bg-gray-600 rounded text-white">임시 저장된 글 (<span id="autosave_count"><?php echo $autosave_count; ?></span>)</button>
    ...
    <?php for ($i = 1; $is_link && $i <= G5_LINK_COUNT; $i++) { ?>
      <div class="bo_w_link write_div my-2 mx-0 relative border">
        ...
        <input type="text" name="wr_link<?php echo $i ?>" value="<?php if ($w == "u") {
                                                                  ...
                                                                  } ?>" id="wr_link<?php echo $i ?>" class="frm_input full_input pl-12 p-1.5 outline-none" size="50">
      </div>
    <?php } ?>
