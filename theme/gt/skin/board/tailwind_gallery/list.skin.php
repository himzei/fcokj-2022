        ...
        <ul class="btn_bo_user float-right m-0 p-0">
        	...
        	<li class="relative float-left w-10 text-center ml-2 bg-white">
		        ...
		        <ul class="more_opt is_list_btn hidden block absolute top-11 right-0 bg-white border z-999 text-base">
		            <li class="border-b p-3 float-inherit w-28 m-0 text-gray-700 text-center bg-white"><button type="submit" name="btn_submit" value="선택삭제" onclick="document.pressed=this.value" class="w-full border-0 bg-white"><i class="fa fa-trash-o" aria-hidden="true"></i> 선택삭제</button></li>
		            <li class="border-b p-3 float-inherit w-28 m-0 text-gray-700 text-center bg-white"><button type="submit" name="btn_submit" value="선택복사" onclick="document.pressed=this.value"><i class="fa fa-files-o" aria-hidden="true"></i> 선택복사</button></li>
		            <li class="border-b p-3 float-inherit w-28 m-0 text-gray-700 text-center bg-white"><button type="submit" name="btn_submit" value="선택이동" onclick="document.pressed=this.value"><i class="fa fa-arrows" aria-hidden="true"></i> 선택이동</button></li>
		        </ul>
		        <?php } ?>
        	</li>
        	<?php }  ?>
		...
		<div class="container mx-auto">
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id="gall_ul">
		        <?php for ($i=0; $i<count($list); $i++) { ?>
		            <div class="gall_box border relative">
						...
						<a href="<?php echo $list[$i]['href'] ?>" class="c-card block bg-white overflow-hidden">
							<div class="relative pb-48 overflow-hidden text-center align-middle">
								<?php
							...
							<div class="mt-2">
		                        ...
		                        <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
			                        ...
			                        <span class="inline-block py-3 leading-none bg-orange-200 text-orange-800 rounded-full font-semibold uppercase tracking-wide text-base"><?php echo cut_str(get_text($list[$i]['wr_subject']), 15); ?></span>
		                            <?php
								...
								<p class="cont p-2 h-24"><?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 68, '..'); ?></p>
								<div class="p-2 border-t text-sm text-gray-700">
									<div class="pt-1.5 text-sm font-semibold text-gray-700 flex justify-between">
